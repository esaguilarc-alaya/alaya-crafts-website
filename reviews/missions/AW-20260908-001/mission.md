# Mission AW-20260908-001: Clarify the Homepage capability landscape, Capability Intelligence, and CIE

## Identity
- Actor: Implementation Actor (Claude Code)
- Mission type: implementation
- Issuer/reviewer: Codex
- Supersedes: None — new owner-authorized revision
...
- Branch: `main`
- Baseline HEAD (pre-issuance): `23b0a24dd786703be4b708806176182288824f1b`
- Main HEAD: `23b0a24dd786703be4b708806176182288824f1b`
- Expected working tree: clean
- Declared user-owned changes and overlap assessment: None; no overlapping active mission or working-tree change was found during issuance preflight.
- Issuance reconciliation permitted: the issuance commit may differ from the baseline only by this `reviews/missions/AW-20260908-001/mission.md`.
- Runtime/deployment/base-path state: `main` equals `origin/main` at the baseline. The public site is live at `https://alayacrafts.com/`. Root and `/alaya-crafts-website` remain supported test modes. This mission does not authorize publication or any remote action.
...
## Required work
1. Perform the absolute-repository preflight. Verify the exact repository root, branch, baseline/main/issuance relationship, clean working tree, immutable packet, upstream relationship, and absence of overlapping active work before editing.
...
## Required proof
- Exact packet/issuance identity, packet SHA-256, repository root, baseline, start/end state, branch, main/upstream relationship, actor commit, and single-parent ancestry.
...
- Required return: `reviews/missions/AW-20260908-001/claude-return.md`
...
- No edit to prior mission packets, prior returns/dispositions, immutable files under `reviews/missions/AW-20260904-004/inputs/`, design studies, design-direction documents, project briefs, QA workbook, QA source register, or mission-candidate list.
...
## Stop conditions
- Stop on a repository-root, packet, issuance, ancestry, branch, main/upstream, working-tree, active-work overlap, or authority mismatch.
- Stop if the issuance delta contains anything except this mission packet.
